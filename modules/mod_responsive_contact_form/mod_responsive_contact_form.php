...
// Requesting form elements
		...
		if (isset($_POST['textoComentario'])) {
			$comentario = $_POST['comentario'];
			$body_html .= $_POST['textoComentario'] . ': '. $comentario . '' . $salto;
		}
		if (isset($_POST['maletaTitulo'])) {
			$maletaTitulo = $_POST['maletaTitulo'];
			$body_html .= "Maleta: " . $maletaTitulo . '' . $salto;
		}
...
<?php	
require JModuleHelper::getLayoutPath('mod_responsive_contact_form', $params->get('layout', 'default'));
?>
