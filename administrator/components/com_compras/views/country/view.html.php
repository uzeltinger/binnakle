...
class ComprasViewCountry extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_compras_MANAGER_COUNTRY_NEW') : JText::_('COM_compras_MANAGER_COUNTRY_EDIT'), 'countries.png');
