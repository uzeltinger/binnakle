...
<script type="text/javascript">
	...
	{
		if (task == 'cupon.cancel' || document.formvalidator.isValid(document.id('item-form')))
		{
...
<div class="form-horizontal">    
    <div class="row-fluid form-horizontal-desktop">
		<div class="span6">			
            ...
            <div class="control-group">
				<div class="control-label">
					<?php echo $this->getForm()->getLabel('code'); ?>
				</div>
				<div class="controls">
					<?php echo $this->getForm()->getInput('code'); ?>
				</div>
			</div>
				...
				<div class="control-group">
					<div class="control-label">
						<?php echo $this->getForm()->getLabel('discount'); ?>
					</div>
					<div class="controls">
						<?php echo $this->getForm()->getInput('discount'); ?>
					</div>
				</div>
