...
class ComprasViewRegions extends JViewLegacy
	{
	protected $items;
	...
	{	
		...
		{
			ComprasHelper::addSubmenu('regions');
		}
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_Compras_MANAGER_REGIONS'));
			...
			JToolBarHelper::divider();
			JToolBarHelper::deleteList('', 'regions.delete','JTOOLBAR_TRASH');
			//JToolBarHelper::custom('regions.delete','remove.png','remove_f2.png','JTOOLBAR_REMOVE', true);
