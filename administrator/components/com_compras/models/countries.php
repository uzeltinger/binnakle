...
class ComprasModelCountries extends JModelList
{
	...
	protected function getListQuery($resolveFKs = true)
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.id, a.region, a.name, a.country_code, a.alias, a.checked_out, a.checked_out_time, a.published, a.ordering')
		);
