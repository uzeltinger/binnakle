...
<section class="page noticias galeria">
...
//$articleLink = JRoute::_(ContentHelperRoute::getArticleRoute($article->slug, $article->catid, $article->language));
                ...
                if (isset($images->image_intro) && !empty($images->image_intro)) :
                    $articleImage = '<img src="'.JURI::base().htmlspecialchars($images->image_intro).'" />';
                ...
                if ($urls && (!empty($urls->urlc))) :
                    $modalLinkPdf = JURI::base().$urls->urlc;
                    $class = "pdf";
                endif;               
...
<?php if ($modalLinkPdf != "") { ?>
    <div class="col-12 col-sm-6 col-md-4 <?php echo 'articleid-'.$article->id; ?>" data-iframe="true" data-src="<?php echo $modalLinkPdf ?>">
        <div class="noticia">
            <div class="contenido">
                <a href="">
                    <img class="img-responsive" src="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>">
                </a>
            </div>
            <div class="epigrafe">
...
<?php } else if ($modalLinkExterno != "") { ?>
    ...
    <div class="col-12 col-sm-6 col-md-4 <?php echo 'articleid-'.$article->id; ?>" data-iframe="false" data-externalLink="<?php echo $modalLinkExterno ?>" data-src="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>" data-sub-html="<h4><?php echo $article->title; ?></p>">
        <div class="noticia">
            <div class="contenido">
...
<?php } else if ($modalLinkVideo != "") { ?>
    ...
    <div class="col-12 col-sm-6 col-md-4 <?php echo 'articleid-'.$article->id; ?>" data-poster="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>" data-src="<?php echo $modalLinkVideo ?>" data-sub-html="<h4><?php echo $article->title; ?></h4>">
        <div class="noticia">
            <div class="contenido">
                <a href="">
                    <img class="img-responsive" src="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>">
...
<?php } else if ($modalLink != "") { ?>
    <div class="col-12 col-sm-6 col-md-4 <?php echo 'articleid-'.$article->id; ?>" data-src="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>" data-sub-html="<h4><?php echo $article->title; ?></p>">
        <div class="noticia">
            <div class="contenido">
                <a href="">
                    <img class="img-responsive" src="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>">
