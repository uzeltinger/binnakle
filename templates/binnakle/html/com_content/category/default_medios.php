...
<?php } else if ($modalLinkExterno != "") { ?>
    ...
    <div class="col-12 col-sm-6 col-md-4" data-iframe="false" data-externalLink="<?php echo $modalLinkExterno ?>" data-src="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>" data-sub-html="<p><?php echo $article->title; ?></p>">
        <div class="noticia">
            <div class="contenido">
...
<?php } else if ($modalLinkVideo != "") { ?>
    ...
    <div class="col-12 col-sm-6 col-md-4" data-poster="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>" data-src="<?php echo $modalLinkVideo ?>" data-sub-html="<h4><?php echo $article->title; ?></h4>">
        <div class="noticia">
            <div class="contenido">
                <a href="">
                    <img class="img-responsive" src="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>">
