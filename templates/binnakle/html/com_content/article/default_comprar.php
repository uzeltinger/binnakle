...
<?php
    ...
    <section class="comprar">
        ...
        <div class="container container-games d-none d-lg-block">
            <div class="row">
                <div class="col-12">
        ...
        <div class="container accordion d-lg-none">
    ...
    <div class="modal fade paypal" id="paypal-modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">×</button>
                ...
                <div id="demo-modal">
                    <iframe class="iframe-paypal" width="100%" height="500" src="https://www.youtube.com/embed/GHe3RflF9ZA?enablejsapi=1&version=3&playerapiid=ytplayer" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
